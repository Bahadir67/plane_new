export default {
  ...
  language_setting: "Kullanıcı arayüzünde kullanılacak dili seçin.",
  settings_moved_to_preferences: "Saat dilimi ve dil ayarları Tercihler'e taşındı.",
  go_to_preferences: "Tercihlere git",
  settings_description:
    "Hesap, çalışma alanı ve proje tercihlerinizi tek yerden yönetin. Sekmeler arasında geçiş yaparak kolayca yapılandırın.",
  ...
  workspace_analytics: {
    ...
    backlog_work_items: "Birikmiş {entity}",
  ...
  account_settings: {
    ...
    preferences: {
      heading: "Tercihler",
      description: "Uygulama deneyiminizi çalışma biçiminize göre özelleştirin",
    },
    notifications: {
    ...
    activity: {
      heading: "Aktivite",
      description: "Tüm projeler ve iş öğeleri genelinde son hareketlerinizi ve değişiklikleri takip edin.",
    },
  },
  workspace_settings: {
    ...
    settings: {
      ...
      billing_and_plans: {
        heading: "Faturalama ve Planlar",
        description: "Planınızı seçin, abonelikleri yönetin ve ihtiyaçlarınız büyüdükçe kolayca yükseltin.",
      ...
      exports: {
        ...
        description: "Proje verilerinizi çeşitli formatlarda dışa aktarın ve indirme bağlantılarıyla dışa aktarma geçmişinize erişin.",
      ...
      webhooks: {
        heading: "Webhook'lar",
        description: "Proje olayları gerçekleştiğinde harici servislere bildirimleri otomatikleştirin.",
        title: "Webhook'lar",
        add_webhook: "Webhook ekle",
        modal: {
          title: "Webhook oluştur",
          details: "Webhook detayları",
          payload: "Payload URL'si",
  ...
  project_settings: {
    ...
    states: {
      heading: "Durumlar",
      description: "İş öğelerinizin ilerlemesini izlemek için iş akışı durumlarını tanımlayın ve özelleştirin.",
    ...
    automations: {
      ...
      description: "Proje yönetimi iş akışınızı sadeleştirmek ve manuel işleri azaltmak için otomatik eylemler yapılandırın.",
      "auto-archive": {
  ...
  power_k: {
    contextual_actions: {
      work_item: {
        ...
        unsubscribe: "Bildirim aboneliğini kaldır",
        delete: "Sil",
        copy_id: "ID kopyala",
        copy_id_toast_success: "İş öğesi ID'si panoya kopyalandı.",
        copy_id_toast_error: "İş öğesi ID'si panoya kopyalanırken hata oluştu.",
        copy_title: "Başlığı kopyala",
        copy_title_toast_success: "İş öğesi başlığı panoya kopyalandı.",
        copy_title_toast_error: "İş öğesi başlığı panoya kopyalanırken hata oluştu.",
        copy_url: "URL'yi kopyala",
        copy_url_toast_success: "İş öğesi URL'si panoya kopyalandı.",
        copy_url_toast_error: "İş öğesi URL'si panoya kopyalanırken hata oluştu.",
      },
      cycle: {
        title: "Döngü işlemleri",
        indicator: "Döngü",
        add_to_favorites: "Favorilere ekle",
        remove_from_favorites: "Favorilerden kaldır",
        copy_url: "URL'yi kopyala",
        copy_url_toast_success: "Döngü URL'si panoya kopyalandı.",
        copy_url_toast_error: "Döngü URL'si panoya kopyalanırken hata oluştu.",
      },
      module: {
        title: "Modül işlemleri",
        indicator: "Modül",
        ...
        copy_url_toast_error: "Modül URL'si panoya kopyalanırken hata oluştu.",
      },
      page: {
        ...
        copy_url_toast_error: "Sayfa URL'si panoya kopyalanırken hata oluştu.",
      },
    },
    creation_actions: {
    ...
    navigation_actions: {
      ...
      nav_projects_list: "Projeler listesine git",
      ...
      nav_project_intake: "Talebe git",
      nav_project_archives: "Proje arşivlerine git",
      open_project_setting: "Proje ayarı aç",
    ...
    miscellaneous_actions: {
      ...
      copy_current_page_url_toast_error: "Geçerli sayfa URL'si panoya kopyalanırken hata oluştu.",
      focus_top_nav_search: "Arama alanına odaklan",
    },
    preferences_actions: {
    ...
    help_actions: {
      ...
      join_discord: "Discord'umuza katılın",
      report_bug: "Hata bildir",
      chat_with_us: "Bizimle sohbet et",
    },
    page_placeholders: {
      default: "Komut yazın veya arayın",
      open_workspace: "Bir çalışma alanı aç",
      open_project: "Bir proje aç",
      open_workspace_setting: "Bir çalışma alanı ayarı aç",
      open_project_cycle: "Bir döngü aç",
      open_project_module: "Bir modül aç",
      open_project_view: "Bir proje görünümü aç",
      open_project_setting: "Bir proje ayarı aç",
      update_work_item_state: "Durumu değiştir",
      update_work_item_priority: "Önceliği değiştir",
      update_work_item_assignee: "Şuna ata",
  ...
  show_limited_projects_on_sidebar: "Kısıtlı projeleri kenar çubuğunda göster",
